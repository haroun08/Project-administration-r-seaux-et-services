...
public class CreateOrderCommand : IRequest<int> {
    ...
    //private static Object MYLOCK {get;set;}
    public class CreateOrderCommandHandler : IRequestHandler<CreateOrderCommand,int>
    {
        ...
        Task<int> IRequestHandler<CreateOrderCommand, int>.Handle(CreateOrderCommand request, CancellationToken cancellationToken)
        {
